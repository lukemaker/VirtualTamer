...
namespace DT
{
    public partial class BattleForm : Form
    {
        ...
        private void damageMove_Tick(object sender, EventArgs e)
        {
            ...
            if (dmm == 90)
            {
                damageBox.Location = new Point(106, 85);
            ...
            else if (dmm == 10)
            {
                ...
                damageBox.Location = new Point(230, 85);
            }
            else if (dmm == 20)
            {
                damageBox.Visible = true;
                damageBox.Location = new Point(201, 85);
            }
            else if (dmm == 30)
            {
                damageBox.Location = new Point(185, 85);
            }
            else if (dmm == 40)
            {
                damageBox.Location = new Point(159, 85);
            }
            else if (dmm == 50)
            {
                damageBox.Location = new Point(142, 85);
            }
            else if (dmm == 60)
            {
                damageBox.Location = new Point(125, 85);
            }
            else if (dmm == 70)
            {
                damageBox.Location = new Point(111, 85);
            }
            else if (dmm == 80)
            {
                damageBox.Visible = false;
